...
//const ProfileSchema = require('../Models/my-profile.model')
const { myProfile ,myProfileDelete} = require('../helpers/validation_schema');
    ...
    getProfile: async (req, res, next) => {
       ...
       updateProfile:  async (req, res, next) => {
            try {
                ...
                const result = await myProfile.validateAsync(req.body)
                console.log(result)
